...
The **l1svr** package estimates the density of the errors using the procedure described in @powell1991estimation, which involves two postive scalar tuning parameters, `h` and `kappa`.
...
To enable the estimation of confidence intervals, set `confidence.level` to a value between 0 and 1.
This argument also determines the confidence level of the intervals.
